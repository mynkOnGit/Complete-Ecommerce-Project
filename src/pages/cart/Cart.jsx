...
function Cart() {
  ...
  const increaseQuantity = (id) => {
    setQuantities((prevQuantities) => {
      ...
      if (newQuantity > 3) {
        toast.error("Cannot exceed quantity limit of 3", {
          position: "top-center",
          autoClose: 1000,
  ...
  useEffect(() => {
    ...
    cartItems.forEach((cartItem) => {
      temp += parseInt(cartItem.price) * (quantities[cartItem.id] || 1);
    });
    setTotalAmount(temp);
    console.log(temp);
                  ...
                  <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                    <div className="mt-5 sm:mt-0">
                      ...
                      <div className="flex mt-4">
                        ...
                        <button onClick={() => increaseQuantity(id)} className="px-2 py-1 bg-gray-200 rounded">+</button>
                      </div>
                    </div>
